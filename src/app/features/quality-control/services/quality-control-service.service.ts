...
const QUALITY_CONTROL_REPORT_API_URL = '/api/vigihelp/medical-assessment-reviews-report';
const QUALITY_CONTROL_API_URL = '/api/vigihelp/medical-assessment-reviews';
